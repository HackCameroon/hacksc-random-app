...
public class API9D4F612EApidfeClient: AWSAPIGatewayClient {

	static let AWSInfoClientKey = "API9D4F612EApidfeClient"

	private static let _serviceClients = AWSSynchronizedMutableDictionary()
	private static let _defaultClient:API9D4F612EApidfeClient = {
        ...
        return API9D4F612EApidfeClient(configuration: serviceConfiguration!)
	}()
	...
	/**
	 ...
	 Then call the following to get the default service client:
	     ...
	     let serviceClient = API9D4F612EApidfeClient.default()

     Alternatively, this configuration could also be set in the `info.plist` file of your app under `AWS` dictionary with a configuration dictionary by name `API9D4F612EApidfeClient`.
	
	 @return The default service client.
	 */ 
	 
	public class func `default`() -> API9D4F612EApidfeClient{
	...
	/**
	 ...
	 If you want to enable AWS Signature, set the default service configuration in `func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?)`
	     ...
	     func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
	         ...
	         API9D4F612EApidfeClient.registerClient(withConfiguration: configuration, forKey: "USWest2API9D4F612EApidfeClient")
	 ...
	 Then call the following to get the service client:
	     ...
	     let serviceClient = API9D4F612EApidfeClient.client(forKey: "USWest2API9D4F612EApidfeClient")
	...
	public class func registerClient(withConfiguration configuration: AWSServiceConfiguration, forKey key: String){
		_serviceClients.setObject(API9D4F612EApidfeClient(configuration: configuration), forKey: key  as NSString);
	}
	 ...
	 */
	public class func client(forKey key: String) -> API9D4F612EApidfeClient {
		objc_sync_enter(self)
		if let client: API9D4F612EApidfeClient = _serviceClients.object(forKey: key) as? API9D4F612EApidfeClient {
			objc_sync_exit(self)
		    return client
		}
		...
		if let serviceInfo = serviceInfo {
			...
			API9D4F612EApidfeClient.registerClient(withConfiguration: serviceConfiguration!, forKey: key)
		}
		objc_sync_exit(self)
		return _serviceClients.object(forKey: key) as! API9D4F612EApidfeClient;
	}
	...
	init(configuration: AWSServiceConfiguration) {
	    ...
	    var URLString: String = "https://1n46x2xso9.execute-api.us-east-1.amazonaws.com/dev"
